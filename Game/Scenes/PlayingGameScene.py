...
class PlayingGameScene(Scene):
    ...
    def render(self):
        """"Renders sprites and text to screen"""
        ...
        print("Amount of bricks left: ", level.getAmountOfBricksLeft())
        ...
        for ball in balls:
            ...
            if ball.intersects(pad):
                game.playSound(GameConstants.SOUND_HTI_PAD)
